...
public final class DialogUtil {
   ...
   */
  public static void open( final Dialog dialog, final DialogCallback dialogCallback ) {
    ParamCheck.notNull( dialog, "dialog" );
    dialog.getParent().getDisplay().asyncExec( new Runnable() {
      public void run() {
        dialogCallback.dialogClosed( SWT.CANCEL );
      }
    } );
  }
